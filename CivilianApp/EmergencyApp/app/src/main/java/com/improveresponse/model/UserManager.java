...
public class UserManager {
    ...
    private static String url = "http://10.0.0.7:2525/UserDatabaseHost/UserDataService.svc/";//the url used to connect
     ...
     */
    public boolean registerUser(String name,String last_name,String dateOfBirth,String sex,String email_acc,int cellNo,String nextKinName,int nextKinNum,String usern,String pass,String cond){
    ...
    public Boolean reportEmergency(String EmergencyType,int EmergencyListId,String location,String extra_info,String date,String username){
        try{
            HttpClient httpClient = new DefaultHttpClient();
            HttpPost httpPost= new HttpPost(url+"ReportEmergency");

            httpPost.setHeader("Content-type", "application/json");
            httpPost.setHeader("Accept", "application/json");
            JSONObject obj = new JSONObject();
            obj.put("EmergencyType", EmergencyType);
            obj.put("EmergencyListId", EmergencyListId);
            obj.put("location", location);
            obj.put("extra_info", extra_info);
            obj.put("date", date);
            obj.put("reporter", username);
